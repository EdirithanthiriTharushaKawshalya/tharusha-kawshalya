...
import { ArrowRight, Terminal, Layers, Code2, Cpu, ExternalLink, Image as ImageIcon, Zap, ShieldCheck, Smartphone, Database, Package, ChevronLeft, ChevronRight, Search, ChevronDown, Cloud, Server, Bot } from "lucide-react";
...
const TECH_STACK = [
  ...
  { name: "PostgreSQL", icon: <Database size={16} className="md:w-5 md:h-5 text-black" /> },
  { name: "Docker", icon: <Package size={16} className="md:w-5 md:h-5 text-black" /> },
  { name: "Node.js", icon: <Server size={16} className="md:w-5 md:h-5 text-black" /> },
  ...
  { name: "Robotics & ROS", icon: <Bot size={16} className="md:w-5 md:h-5 text-black" /> },
];
